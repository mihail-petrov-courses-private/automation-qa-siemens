...
Програмата на терминала генерира номер на клиента, на базата на отговорите на пикантни въпроси. След като въпросите приключат, потребителят получава карта, съдържаща **6 цифрен номер.**
